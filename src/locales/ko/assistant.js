const assistant = {
  ...
  third: {
    ...
    1: {
      title: "마일스톤 검증",
      text: "모든 채용은 최소 한 달 이상의 마일스톤을 설정해야 하며, 요청 시 클라이언트의 전달 내용과 개발자의 이해사항이 일치하는지 확인해 드립니다.",
    },
    2: {
      title: "분쟁시 관여",
      text: "매달 개발자에 대한 평가를 진행하며, 문제가 있을 시 kookje.in에서 마일스톤과 개발자의 업무내용을 바탕으로 분쟁을 조정합니다.",
    },
    3: {
      title: "비상 상황 해결",
