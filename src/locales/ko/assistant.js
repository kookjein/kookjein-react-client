...
const assistant = {
  ...
  second: {
    ...
    1: {
      title: "베이식 플랜",
      text: "개발자 매칭 시 마일스톤을 검증해 주고 분쟁이 일어날 시 분쟁을 해결해 줍니다.",
    },
    2: {
      title: "스탠다드 플랜",
      text: "개발자와의 소통을 도와줄 어시스턴트에게 월 30시간에 한에 업무시간에 도움을 요청할 수 있습니다.",
    },
    3: {
      title: "엔터프라이즈 플랜",
      text: "개발 지식을 보유하고 언어에 능통한 PM이 개발자와의 소통을 전담하며 프로젝트 중간관리와 일정을 조율합니다.",
    },
  },
  third: {
    title: "어시스턴트의 역할",
