  ...
  return (
    <div className="w-full h-full flex flex-col items-center overflow-x-hidden">
      <div className="w-full h-screen flex flex-col items-center justify-center">
        ...
        <p className="text-6xl mt-4 text-gray-600 text-green-700">Server maintenance</p>
        <p className="text-xl mt-4 text-zinc-400 text-green-700">We're improving Kookjein - We'll be right back.</p>
